...
type MonthlyPlan = PricingPlan;

type YearlyPlan = PricingPlan;

type Tab = {
  value: Billing;
  tabName: string;
  pricingPlans: MonthlyPlan[] | YearlyPlan[];
};
...
export const Pricing27 = (props: Pricing27Props) => {
  const { tagline, heading, description, tabs, featureCategories, buttons } = {
    ...Pricing27Defaults,
    ...props,
  } as Props;
